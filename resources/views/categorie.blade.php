        ...
        <div class="deznav">
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow ai-icon" href="{{route('user')}}" aria-expanded="false">
					...
					<li><a class="has-arrow ai-icon" href="{{route('categorie')}}" aria-expanded="false">
						<i class="flaticon-381-television"></i>
						<span class="nav-text">categorie</span>
					</a>
					<ul aria-expanded="false">
						<li><a href="{{url('/categorie')}}">Categorie List</a></li>
								...
								<div class="card-body">
									<table class="table table-striped">
										...
										<tr>
											...
											<td><img width="100" src="{{asset('uploads/category')}}/{{$category->category_image}}"></td>
										    <td>{{$category->rel_to_table->name}}</td>
											...
											<td>
												<div class="dropdown">
													...
													<div class="dropdown-menu">
														...
														<a class="dropdown-item" href="{{route('fixed_delete',$category->id)}}">Permanent Delete</a>
								...
								<div class="card-body">
									<table class="table table-striped">
										...
										<tr>
											...
											<td><img width="100" src="{{asset('uploads/category')}}/{{$trash->category_image}}"></td>
										    <td>{{$trash->rel_to_table->name}}</td>
											...
											<td>
												<div class="dropdown">
													...
													<div class="dropdown-menu">
														...
														<a class="dropdown-item" href="{{route('permanent_delete',$trash->id)}}">Permanent Delete</a>
													</div>
												</div>
											</td>
										</tr>
...
@endif
                                       ...
                                       <div class="mb-3">
                                        ...
                                        <input type="file" name="category_image" class="form-control" value="" onchange="document.getElementById('image_category').src = window.URL.createObjectURL(this.files[0])">
                                      <br>
									  <img id="image_category" src="" width="100">
                
                                    </div>
                                       <div class="mb-3">
                                          
                                           <button type="submit"  class="btn btn-danger" >Update a Name</button>
