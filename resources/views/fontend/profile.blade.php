        ...
        <div class="row align-items-start justify-content-between">
                ...
                <div class="d-block border rounded mfliud-bot">
                    <div class="dashboard_author px-2 py-5">
                        <div class="dash_auth_thumb circle p-1 border d-inline-flex mx-auto mb-2">
                           ...
                           <img src="{{Avatar::create(Auth::guard('customerlogin')->user()->name)->toBase64()}}" alt="" width="50">
                               @else
                               <img src="{{asset('uploads/customer')}}/{{Auth::guard('customerlogin')->user()->photo}}" class="circle" alt="" width="100" height="100">
            ...
            <div class="col-12 col-md-12 col-lg-8 col-xl-8">
                ...
                <div class="row align-items-center">
                    ...
                    <p class="alert {{ Session::get('alert-class', 'alert-danger') }}">{{ Session::get('error_image') }}</p>
                     @endif
                    @if(Session::has('error_mss'))
                   <p class="alert {{ Session::get('alert-class', 'alert-danger') }}">{{ Session::get('error_mss') }}</p>
                    @endif
                   ...
                   @if(Session::has('message'))
                    ...
                    <p class="alert {{ Session::get('alert-class', 'alert-info') }}">{{ Session::get('message_fail') }}</p>
                    @endif
