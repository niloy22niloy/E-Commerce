                ...
                <div class="killore-new-block-link border mb-3 mt-3">
                    ...
                    <div class="killore--block-link-content">
                        <ul>
                            ...
                            <li><a href="javascript:void(0);"><img style="height:40px;width:40px;" src="{{asset('uploads/category')}}/{{$category->category_image}}"> &nbsp;{{$category->category_name}}</a></li>
                            @endforeach
        ...
        <div class="row align-items-center rows-products">			
            ...
            <div class="col-xl-3 col-lg-4 col-md-6 col-6">
                <div class="product_grid card b-0">
                    ...
                    @else
                    <div class="badge bg-danger text-white position-absolute ft-regular ab-right text-upper">No Discount</div>
                    @endif
                    ...
                    <div class="card-footer b-0 p-0 pt-2 bg-white d-flex align-items-start justify-content-between">
                        <div class="text-left">
                            <div class="text-left">
                                <div class="elso_titl"><span class="small">{{$product->brand}}</span></div>
                                ...
                                <div class="elis_rty">
                                    ...
                                    <span class="fr-bold text-dark fs-sm">৳ {{$product->after_discount}}</span>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row align-items-center justify-content-center">
            <div class="col-xl-2 col-lg-2 col-md-3 col-sm-6 col-4">
                <div class="cats_side_wrap text-center mx-auto mb-3">
                    <div class="sl_cat_01"><div class="d-inline-flex align-items-center justify-content-center p-4 circle mb-2 border"><a href="javascript:void(0);" class="d-block"><img src="{{asset('frontend_asset/img/headphones.png')}}" class="img-fluid" width="40" alt=""></a></div></div>
            ...
            <div class="col-xl-2 col-lg-2 col-md-3 col-sm-6 col-4">
                <div class="cats_side_wrap text-center mx-auto mb-3">
                    <div class="sl_cat_01"><div class="d-inline-flex align-items-center justify-content-center p-4 circle mb-2 border"><a href="javascript:void(0);" class="d-block"><img src="{{asset('frontend_asset/img/watch.png')}}" class="img-fluid" width="40" alt=""></a></div></div>
            ...
            <div class="col-xl-2 col-lg-2 col-md-3 col-sm-6 col-4">
                <div class="cats_side_wrap text-center mx-auto mb-3">
                    <div class="sl_cat_01"><div class="d-inline-flex align-items-center justify-content-center p-4 circle mb-2 border"><a href="javascript:void(0);" class="d-block"><img src="{{asset('frontend_asset/img/washing-machine.png')}}" class="img-fluid" width="40" alt=""></a></div></div>
            ...
            <div class="col-xl-2 col-lg-2 col-md-3 col-sm-6 col-4">
                <div class="cats_side_wrap text-center mx-auto mb-3">
                    <div class="sl_cat_01"><div class="d-inline-flex align-items-center justify-content-center p-4 circle mb-2 border"><a href="javascript:void(0);" class="d-block"><img src="{{asset('frontend_asset/img/cell-phone.png')}}" class="img-fluid" width="40" alt=""></a></div></div>
            ...
            <div class="col-xl-2 col-lg-2 col-md-3 col-sm-6 col-4">
                <div class="cats_side_wrap text-center mx-auto mb-3">
                    <div class="sl_cat_01"><div class="d-inline-flex align-items-center justify-content-center p-4 circle mb-2 border"><a href="javascript:void(0);" class="d-block"><img src="{{asset('frontend_asset/img/safety-goggles.png')}}" class="img-fluid" width="40" alt=""></a></div></div>
            ...
            <div class="col-xl-2 col-lg-2 col-md-3 col-sm-6 col-4">
                <div class="cats_side_wrap text-center mx-auto mb-3">
                    <div class="sl_cat_01"><div class="d-inline-flex align-items-center justify-content-center p-4 circle mb-2 border"><a href="javascript:void(0);" class="d-block"><img src="{{asset('frontend_asset/img/camera.png')}}" class="img-fluid" width="40" alt=""></a></div></div>
            ...
            <div class="col-xl-2 col-lg-2 col-md-3 col-sm-6 col-4">
                <div class="cats_side_wrap text-center mx-auto mb-3">
                    <div class="sl_cat_01"><div class="d-inline-flex align-items-center justify-content-center p-4 circle mb-2 border"><a href="javascript:void(0);" class="d-block"><img src="{{asset('frontend_asset/img/fashion.png')}}" class="img-fluid" width="40" alt=""></a></div></div>
            ...
            <div class="col-xl-2 col-lg-2 col-md-3 col-sm-6 col-4">
                <div class="cats_side_wrap text-center mx-auto mb-3">
                    <div class="sl_cat_01"><div class="d-inline-flex align-items-center justify-content-center p-4 circle mb-2 border"><a href="javascript:void(0);" class="d-block"><img src="{{asset('frontend_asset/img/tshirt.png')}}" class="img-fluid" width="40" alt=""></a></div></div>
            ...
            <div class="col-xl-2 col-lg-2 col-md-3 col-sm-6 col-4">
                <div class="cats_side_wrap text-center mx-auto mb-3">
                    <div class="sl_cat_01"><div class="d-inline-flex align-items-center justify-content-center p-4 circle mb-2 border"><a href="javascript:void(0);" class="d-block"><img src="{{asset('frontend_asset/img/accessories.png')}}" class="img-fluid" width="40" alt=""></a></div></div>
            ...
            <div class="col-xl-2 col-lg-2 col-md-3 col-sm-6 col-4">
                <div class="cats_side_wrap text-center mx-auto mb-3">
                    <div class="sl_cat_01"><div class="d-inline-flex align-items-center justify-content-center p-4 circle mb-2 border"><a href="javascript:void(0);" class="d-block"><img src="{{asset('frontend_asset/img/sneakers.png')}}" class="img-fluid" width="40" alt=""></a></div></div>
            ...
            <div class="col-xl-2 col-lg-2 col-md-3 col-sm-6 col-4">
                <div class="cats_side_wrap text-center mx-auto mb-3">
                    <div class="sl_cat_01"><div class="d-inline-flex align-items-center justify-content-center p-4 circle mb-2 border"><a href="javascript:void(0);" class="d-block"><img src="{{asset('frontend_asset/img/television.png')}}" class="img-fluid" width="40" alt=""></a></div></div>
            ...
            <div class="col-xl-2 col-lg-2 col-md-3 col-sm-6 col-4">
                <div class="cats_side_wrap text-center mx-auto mb-3">
                    <div class="sl_cat_01"><div class="d-inline-flex align-items-center justify-content-center p-4 circle mb-2 border"><a href="javascript:void(0);" class="d-block"><img src="{{asset('frontend_asset/img/pant.png')}}" class="img-fluid" width="40" alt=""></a></div></div>
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                ...
                <div class="ftr-content">
                    @foreach ($featured_product as $featured_pro )
                    <div class="product_grid row">
                        <div class="col-xl-4 col-lg-5 col-md-5 col-4">
                            <div class="shop_thumb position-relative">
                                <a class="card-img-top d-block overflow-hidden" href="shop-single-v1.html"><img style="width:70px;" class="card-img-top" src="{{asset('uploads/product/preview')}}/{{$featured_pro->preview}}" alt="..."></a>
                            </div>
                        </div>
                        <div class="col-xl-8 col-lg-7 col-md-7 col-8 pl-0">
                            <div class="text-left mfliud">
                                <div class="elso_titl"><span class="small">{{$featured_pro->brand}}</span></div>
                                <h5 class="fs-md mb-0 lh-1 mb-1 ft-medium">{{$featured_pro->product_name}}</h5>
                                {{-- <div class="star-rating align-items-center d-flex justify-content-left mb-2 p-0">
                                    <i class="fas fa-star filled"></i>
                                    <i class="fas fa-star filled"></i>
                                    <i class="fas fa-star filled"></i>
                                ...
                                <div class="elis_rty"><span class="ft-bold text-dark fs-sm">৳ {{$featured_pro->price}}</span></div>
                            </div>
                        </div>
                    </div>
                    @endforeach
