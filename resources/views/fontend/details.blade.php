        ...
        <div class="row justify-content-between">
            ...
            <div class="col-xl-5 col-lg-6 col-md-12 col-sm-12">
                ...
                <div class="quick_view_slide">
                    ...
                    <div class="single_view_slide"><a href="{{asset('uploads/product/thumbnail')}}/{{$thumb->thumbnail}}" data-lightbox="roadtrip" class="d-block mb-4"><img src="{{asset('uploads/product/thumbnail')}}/{{$thumb->thumbnail}}"  class="img-fluid rounded" alt="" /></a></div>
                ...
                <div class="prd_details pl-3">
                    ...
                    <div class="prt_02 mb-3">
                        ...
                        <div class="text-left">
                            ...
                            <div class="elis_rty"><span class="ft-medium text-muted line-through fs-md mr-2"></span><span class="ft-bold theme-cl fs-lg mr-2"> {{$product_info->first()->price }}(no Discount)
                        </span>
                        @else
                        <div class="elis_rty"><span class="ft-medium text-muted line-through fs-md mr-2">{{$product_info->first()->price }}</span><span class="ft-bold theme-cl fs-lg mr-2"> 
                            {{$product_info->first()->after_discount }}(discount){{$product_info->first()->discount}}%
                        </span>
                        @endif
                            {{-- <div class="elis_rty"><span class="ft-medium text-muted line-through fs-md mr-2">{{$product_info->first()->price }}</span><span class="ft-bold theme-cl fs-lg mr-2"> --}}
                            </span></div>
                    ...
                    <div class="prt_04 mb-4">
                        ...
                        <div class="text-left pb-0 pt-2 size_id">
                          ...
                          <div class="form-check size-option form-option form-check-inline mb-2">
                              <input class="form-check-input" type="radio" value="{{$size->id}}" name="size_id" id="size{{$size->id}}" >
            ...
            <div class="col-xl-11 col-lg-12 col-md-12 col-sm-12">
                <ul class="nav nav-tabs b-0 d-flex align-items-center justify-content-center simple_tab_links mb-4" id="myTab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <a class="nav-link active" id="description-tab" href="#description" data-toggle="tab" role="tab" aria-controls="description" aria-selected="true">Descriptio</a>
                    </li>
                    <li class="nav-item" role="presentation">
                        ...
                        <div class="product_grid card b-0 mb-0">
                            ...
                            <div class="card-body p-0">
                                <div class="shop_thumb position-relative">
                                    <a class="card-img-top d-block overflow-hidden" href="{{route('product.details',$related->slug)}}"><img class="card-img-top" src="{{asset('uploads/product/preview')}}/{{$related->preview}}" alt="..."></a>
                                </div>
                            </div>
                            <div class="card-footer b-0 p-3 pb-0 d-flex align-items-start justify-content-center">
                                <div class="text-left">
                                    <div class="text-center">
                                        <h5 class="fw-bolder fs-md mb-0 lh-1 mb-1"><a href="{{route('product.details',$related->slug)}}">{{$related->product_name}}</a></h5>
                                        <div class="elis_rty"><span class="ft-bold fs-md text-dark">Tk- {{$related->price}}</span></div>
                                    </div>
                                </div>
                            </div>
                        </div>
