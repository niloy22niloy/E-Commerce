            ...
            <div class="col-12 col-lg-7 col-md-12">
                <form action="{{route('order.store')}}" method="POST">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8 mcol-8">
                            <div class="form-group">
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col d-flex align-items-center">
                                    <div class="cart_single_caption pl-2">
                                        <h4 class="product_title fs-md ft-medium mb-1 lh-1">Product Name: {{$cart->rel_to_product->product_name}}</h4>
                                        <p class="mb-1 lh-1"><span class="text-dark">Size : {{($cart->size_id == null)?'Not Available Color':$cart->rel_to_size->size_name}}</span></p>
                                        <p class="mb-3 lh-1"><span class="text-dark">Color: {{($cart->color_id == null)?'Not Available Color':$cart->rel_to_color->color_name}}</span></p>
                ...
                <div class="card mb-4 gray">
                  <div class="card-body">
                    <ul class="list-group list-group-sm list-group-flush-y list-group-flush-x">
                      ...
                      <li class="list-group-item d-flex text-dark fs-sm ft-regular">
                        <span>Charge</span> <span class="ml-auto text-dark ft-medium" >TK<span id="charge"></span></span>
                      </li>
                      <li class="list-group-item d-flex text-dark fs-sm ft-regular">
                        <span>Total</span> <span class="ml-auto text-dark ft-medium" >Tk<span id="total">0</span></span>
                      </li>
                    </ul>
                  </div>
                </div>
...
<script>
    $('.charge').click(function(){
         ...
         var total = parseInt(charge) + parseInt(sub_total);
         $('#charge').html(charge);
         $('#total').html(total);
    });
</script>
