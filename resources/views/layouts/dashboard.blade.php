        ...
        <div class="deznav">
            <div class="deznav-scroll">
				<ul class="metismenu" id="menu">
					...
					<ul aria-expanded="false">
						<li><a href="{{url('/categorie')}}">Categorie Lists</a></li>
						<li><a href="{{route('sub_category')}}">Sub Categorie List</a></li>
				...
				<ul aria-expanded="false">
					<li><a href="{{route('add.products')}}">Add Product Lists</a></li>
					<li><a href="{{route('product.list')}}"> Product Lists</a></li>
					<li><a href="{{route('add.variation')}}"> Add color</a></li>
